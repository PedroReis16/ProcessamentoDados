...
int main()
{
	...
	std::vector<int> random1 = GeraValores::geraVetor(1000);
	std::vector<int> random2 = GeraValores::geraVetor(3000);
	std::vector<int> random3 = GeraValores::geraVetor(5000);
	std::vector<int> random4 = GeraValores::geraVetor(10000);
